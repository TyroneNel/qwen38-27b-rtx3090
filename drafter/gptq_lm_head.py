...
# every other weight shard is copied (7 model-0000x shards for the base model, one
...
# prepare/build_draft_vocab.py rewrites both of these in the variant -- the extras with
# save_file (in place on safetensors <= 0.7) and the ids with torch.save (in place on every
# torch: it truncates the open inode) -- which is the concrete case the F04 note above guards
